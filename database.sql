...
VALUES
  ...
  ('Delta', 'Bergen', 'New York', 'BGO', 'JFK', '~12h'),
  ('KLM', 'Bergen', 'New York', 'BGO', 'JFK', '~12h'),
  ('Lufthansa', 'Stavanger', 'Rome', 'SVG', 'FCO', '5-6h'),
  ('Icelandair', 'Tromsø', 'Reykjavik', 'TOS', 'KEF', '~3h'),
  ('Austrian Airlines', 'Kristiansand', 'Vienna', 'KRS', 'VIE', '4-5h'),
  ('Aegean', 'Bodø', 'Athens', 'BOO', 'ATH', '7-9h'),
  ('SAS', 'Bodø', 'Athens', 'BOO', 'ATH', '7-9h'),
  ('Norwegian', 'Ålesund', 'Berlin', 'AES', 'BER', '3-4h'),
  ('SAS', 'Trondheim', 'Dublin', 'TRD', 'DUB', '5-7h'),
  ('Lufthansa', 'Trondheim', 'Dublin', 'TRD', 'DUB', '5-7h'),
  ('Qatar Airways', 'Oslo', 'Cape Town', 'OSL', 'CPT', '16-20h'),
  ('Emirates', 'Oslo', 'Cape Town', 'OSL', 'CPT', '16-20h');
...
VALUES
  ...
  (5001, 'Expedia', 180.00, 'FLIGHT', 1, NULL),
  (5002, 'Hotels.com', 635.00, 'HOTEL', NULL, 1),
  (5002, 'Kayak', 170.00, 'FLIGHT', 2, NULL),
  ...
  (5003, 'Skyscanner', 220.00, 'FLIGHT', 3, NULL),
  (5004, 'Agoda', 535.00, 'HOTEL', NULL, 2),
  (5004, 'Momondo', 225.00, 'FLIGHT', 4, NULL),
  ...
  (5005, 'Expedia', 255.00, 'FLIGHT', 5, NULL),
  (5006, 'Booking.com', 890.00, 'HOTEL', NULL, 3),
  (5006, 'Momondo', 245.00, 'FLIGHT', 6, NULL),
  ...
  (5007, 'Skyscanner', 840.00, 'FLIGHT', 7, NULL),
  (5008, 'Hotels.com', 1005.00, 'HOTEL', NULL, 4),
  (5008, 'Expedia', 815.00, 'FLIGHT', 8, NULL),
  (2032, 'Hotels.com', 1120.00, 'HOTEL', NULL, 5),
  (2032, 'Booking.com', 1150.00, 'HOTEL', NULL, 5),
  (2032, 'Expedia', 540.00, 'FLIGHT', 9, NULL),
  (2032, 'FlightFinder', 515.00, 'FLIGHT', 9, NULL),
  (2032, 'Kayak', 525.00, 'FLIGHT', 10, NULL),
  (5009, 'Booking.com', 1135.00, 'HOTEL', NULL, 5),
  (5009, 'Skyscanner', 545.00, 'FLIGHT', 10, NULL),
  (5010, 'Hotels.com', 1110.00, 'HOTEL', NULL, 5),
  (5010, 'Momondo', 530.00, 'FLIGHT', 9, NULL),
  (2059, 'Booking.com', 480.00, 'HOTEL', NULL, 6),
  (2059, 'Agoda', 455.00, 'HOTEL', NULL, 6),
  (2059, 'Momondo', 210.00, 'FLIGHT', 11, NULL),
  (2059, 'Skyscanner', 230.00, 'FLIGHT', 11, NULL),
  (5011, 'Hotels.com', 495.00, 'HOTEL', NULL, 6),
  (5011, 'Kayak', 220.00, 'FLIGHT', 11, NULL),
  (5012, 'Booking.com', 470.00, 'HOTEL', NULL, 6),
  (5012, 'Expedia', 225.00, 'FLIGHT', 11, NULL),
  (2034, 'Hotels.com', 690.00, 'HOTEL', NULL, 7),
  (2034, 'Booking.com', 705.00, 'HOTEL', NULL, 7),
  (2034, 'Kayak', 260.00, 'FLIGHT', 12, NULL),
  (2034, 'Skyscanner', 250.00, 'FLIGHT', 12, NULL),
  (5013, 'Booking.com', 715.00, 'HOTEL', NULL, 7),
  (5013, 'Expedia', 265.00, 'FLIGHT', 12, NULL),
  (5014, 'Hotels.com', 700.00, 'HOTEL', NULL, 7),
  (5014, 'Momondo', 255.00, 'FLIGHT', 12, NULL),
  (2035, 'Agoda', 780.00, 'HOTEL', NULL, 8),
  (2035, 'Booking.com', 820.00, 'HOTEL', NULL, 8),
  (2035, 'Kiwi.com', 320.00, 'FLIGHT', 13, NULL),
  (2035, 'Momondo', 305.00, 'FLIGHT', 13, NULL),
  (5015, 'Hotels.com', 790.00, 'HOTEL', NULL, 8),
  (5015, 'Kayak', 315.00, 'FLIGHT', 13, NULL),
  (5016, 'Booking.com', 810.00, 'HOTEL', NULL, 8),
  (5016, 'Skyscanner', 300.00, 'FLIGHT', 13, NULL),
  (4092, 'Booking.com', 540.00, 'HOTEL', NULL, 9),
  (4092, 'Agoda', 515.00, 'HOTEL', NULL, 9),
  (4092, 'Skyscanner', 410.00, 'FLIGHT', 14, NULL),
  (4092, 'Kayak', 395.00, 'FLIGHT', 15, NULL),
  (5017, 'Hotels.com', 555.00, 'HOTEL', NULL, 9),
  (5017, 'Expedia', 405.00, 'FLIGHT', 14, NULL),
  (5018, 'Booking.com', 525.00, 'HOTEL', NULL, 9),
  (5018, 'Momondo', 400.00, 'FLIGHT', 15, NULL),
  (2037, 'Hotels.com', 420.00, 'HOTEL', NULL, 10),
  (2037, 'Booking.com', 440.00, 'HOTEL', NULL, 10),
  (2037, 'Expedia', 145.00, 'FLIGHT', 16, NULL),
  (2037, 'Momondo', 150.00, 'FLIGHT', 16, NULL),
  (5019, 'Booking.com', 430.00, 'HOTEL', NULL, 10),
  (5019, 'Skyscanner', 148.00, 'FLIGHT', 16, NULL),
  (5020, 'Hotels.com', 435.00, 'HOTEL', NULL, 10),
  (5020, 'Kayak', 152.00, 'FLIGHT', 16, NULL),
  (2038, 'Booking.com', 625.00, 'HOTEL', NULL, 11),
  (2038, 'Agoda', 600.00, 'HOTEL', NULL, 11),
  (2038, 'Kayak', 260.00, 'FLIGHT', 17, NULL),
  (2038, 'Skyscanner', 245.00, 'FLIGHT', 18, NULL),
  (5021, 'Hotels.com', 635.00, 'HOTEL', NULL, 11),
  (5021, 'Expedia', 265.00, 'FLIGHT', 17, NULL),
  (5022, 'Booking.com', 615.00, 'HOTEL', NULL, 11),
  (5022, 'Momondo', 250.00, 'FLIGHT', 18, NULL),
  (2039, 'Hotels.com', 1150.00, 'HOTEL', NULL, 12),
  (2039, 'Booking.com', 1180.00, 'HOTEL', NULL, 12),
  (2039, 'Skyscanner', 980.00, 'FLIGHT', 19, NULL),
  (2039, 'Expedia', 1020.00, 'FLIGHT', 20, NULL),
  (5023, 'Booking.com', 1165.00, 'HOTEL', NULL, 12),
  (5023, 'Kayak', 990.00, 'FLIGHT', 19, NULL),
  (5024, 'Hotels.com', 1175.00, 'HOTEL', NULL, 12),
  (5024, 'Momondo', 1015.00, 'FLIGHT', 20, NULL);
